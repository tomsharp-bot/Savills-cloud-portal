...
async function main() {
  ...
  const projects: { name: string; projectManager: string; stage: ProjectStage; extra?: Record<string, boolean> }[] = [
    ...
    { name: "Cornwall CC Ph1", projectManager: "Greg K", stage: "archive" },
    { name: "Plymouth Stock 2024", projectManager: "Carly M", stage: "archive" },
    { name: "Devon HA Wave 1", projectManager: "Greg K", stage: "archive" },
    { name: "Torbay Pilot", projectManager: "Tom S", stage: "archive" },
    { name: "West Devon Close-out", projectManager: "Carly M", stage: "archive" },
